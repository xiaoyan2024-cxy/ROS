...
urlpatterns = [
    ...
    path("admin/task/cancel", views.admin.task.cancel),
    ...
    path("admin/type/list", views.admin.type.list_api),
    path("admin/type/create", views.admin.type.create),
    ...
    path(
        "index/thing/increaseRecommendCount", views.index.thing.increaseRecommendCount
    ),
