<template>
      ...
      <div class="main">
        <a-row :gutter="[20,20]">
          <a-col :sm="24" :md="12" :lg="6">
            <a-card size="small" title="数据总数">
              <template #extra>
                <a-tag color="blue" slot="extra">总计</a-tag>
              </template>
  
              <div class="box">
                <div class="box-top">
                  <span class="box-value">{{ tdata.data.data_count}}<span class="v-e">条</span></span>
                </div>
                <div class="box-bottom">
                  <span>本周新增 {{ tdata.data.data_week_count }} 条</span>
                </div>
              </div>
            </a-card>
          </a-col>
          ...
          <a-col :sm="24" :md="12" :lg="6">
            <a-card size="small" title="任务总数">
              ...
              <div class="box">
                <div class="box-top">
                  <span class="box-value">{{ tdata.data.task_count }}<span class="v-e">个</span></span>
                </div>
                <div class="box-bottom">
                  <span>共 {{ tdata.data.task_user_count}} 人</span>
                </div>
              </div>
            </a-card>
          </a-col>
          ...
          <a-col :sm="24" :md="12" :lg="6">
            <a-card size="small" title="运行完成">
              <template #extra>
                <a-tag color="green" slot="extra">已完成</a-tag>
              </template>
              <div class="box">
                <div class="box-top">
                  <span class="box-value">{{ tdata.data.task_finished_count }}<span class="v-e">个</span></span>
                </div>
                <div class="box-bottom">
                  <span>共 {{ tdata.data.task_finished_user_count }} 人</span>
                </div>
              </div>
            </a-card>
          </a-col>
          ...
          <a-col :sm="24" :md="12" :lg="6">
            <a-card size="small" title="取消任务">
  
              <template #extra>
                <a-tag color="yellow" slot="extra">已取消</a-tag>
              </template>
  
              <div class="box">
                <div class="box-top">
                  <span class="box-value">{{ tdata.data.task_cancelled_count }}<span class="v-e">个</span></span>
                </div>
                <div class="box-bottom">
                  <span>共 {{ tdata.data.task_cancelled_user_count }} 人</span>
                </div>
              </div>
            </a-card>
          </a-col>
  ...
  import {listApi} from '/@/api/admin/analysis'
